...
public class SimulationWindow extends JFrame {
	...
	/**
	 * Constructor for simulation window; takes {@link LWJGLSwingSimulationController} argument to gain access to
	 * starting and stopping threads for {@link LWJGLWorld} on this thread
	 * 
	 * @param controller
	 */
	public SimulationWindow(LWJGLSwingSimulationController controller) {
