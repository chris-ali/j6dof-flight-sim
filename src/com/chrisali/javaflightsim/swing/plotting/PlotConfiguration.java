...
public class PlotConfiguration implements Saveable {
	...
	public void setSSubPlotBundles(Map<String, SubPlotBundle> subPlotBundles) { this.subPlotBundles = subPlotBundles; }
	...
	public static class SubPlotBundle {
		...
		private Pair<Integer, Integer> sizePixels;
		...
		public Pair<Integer, Integer> getSizePixels() { return sizePixels; }

		public void setSizePixels(Pair<Integer, Integer> sizePixels) { this.sizePixels = sizePixels; }
	}
