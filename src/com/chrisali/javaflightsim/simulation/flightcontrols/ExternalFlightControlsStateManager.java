 ...
 *
 */
public class ExternalFlightControlsStateManager implements Steppable, InputDataListener {

	private static final Logger logger = LogManager.getLogger(ExternalFlightControlsStateManager.class);
	...
	public ExternalFlightControlsStateManager(SimulationController simController, AtomicInteger simTimeMS) {
