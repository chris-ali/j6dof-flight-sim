...
public class Altimeter extends AbstractGauge {
	...
	public Altimeter(Vector2f position, float scale) {
		super(position, scale, null);
		
		Map<String, InterfaceTexture> altimeterTextures = new LinkedHashMap<>();
		InterfaceTexture texture = new InterfaceTexture(0, position, 0.0f, new Vector2f(scale, scale));
		altimeterTextures.put(BACK, texture);
		altimeterTextures.put(POINTER_10000, texture);
		altimeterTextures.put(POINTER_1000, texture);
		altimeterTextures.put(POINTER_100, texture);
		
		gaugeTextures = altimeterTextures;
	}
